...
const CardBelowHome = () => {
  ...
  return (
    <div className='dark-grey-container'>
      ...
      <div className='right-para'><p className='we-do'>WHAT WE DO?</p>"With a focus on pet adoption and reuniting lost pets with their families, FetchMeHome makes it easy to find a loving companion or bring a missing pet back home."</div>
    </div>
  )
}
